...
| 40_Projects/claude_code/00_indice.md | Pesquisa: Claude Code (anthropics/claude-code) — Arquitetura do Harness | moc, claude-code, ai-agent, harness, agent-architecture | 2026-09-17 | projetos_ita |
| 40_Projects/opencode/00_indice.md | Pesquisa: opencode (anomalyco/opencode) — Arquitetura para Harness | moc, opencode, ai-agent, harness, agent-architecture | 2026-09-08 | projetos_ita |
